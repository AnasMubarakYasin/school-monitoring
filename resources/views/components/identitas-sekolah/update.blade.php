{{-- <div class="grid text-gray-900 border border-gray-200 rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700 p-5">
    <h1 class="font-bold dark:text-white capitalize">school identity</h1>
    ...
    <h1 class="font-bold dark:text-white">Address</h1>
    <hr class="border-2 rounded-full border-gray-600 dark:border-gray-300 shadow-2xl">
    <div class="ml-8 mt-2 grid gap-y-2.5">
        <div class="grid grid-cols-5 items-center gap-12">
    ...
    <h1 class="font-bold dark:text-white">Contact</h1>
    <hr class="border-2 rounded-full border-gray-600 dark:border-gray-300 shadow-2xl">
    <div class="ml-8 mt-2 grid gap-y-2.5">
        <div class="grid grid-cols-5 items-center gap-12">
    ...
    <div class="mt-6 text-center">
        <a href="{{ $resource->id }}"
            class="w-full sm:w-1/2 lg:w-1/4 capitalize text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">edit
            identity </a>
    </div>
</div> --}}
