...
<a href=""
    ...
    <div class="bg-[#e7d5b8] w-[70px] h-[70px] rounded-lg grid place-content-center"><svg
...
<a href=""
    class="grid grid-cols-3 p-2 bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-none border dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all">
    <div class="bg-[#e98e8e9c] w-[70px] h-[70px] rounded-lg grid place-content-center"><svg
...
<a href=""
    class="grid grid-cols-3 p-2 bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-none border dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all">
    <div class="bg-[#8dcf5793] w-[70px] h-[70px] rounded-lg grid place-content-center"><svg
            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            stroke="currentColor" class="w-11">
            <path stroke-linecap="round" stroke-linejoin="round"
